...
This repository is ready to deploy as a Railway web service.
...
### Recommended setup
1. Deploy the backend as its own Railway service if you want live chat and dashboard data.
2. Copy the backend service URL into `NEXT_PUBLIC_CHAT_API_URL` for the frontend.
3. Add your Railway domain to Firebase Authentication authorized domains.
